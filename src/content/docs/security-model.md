...
[Disponible en francais](/security-model/)
...
![Security trust boundaries](/diagrams/security-trust-boundaries.svg)
...
![Agent permission ladder](/diagrams/agent-permission-ladder.svg)
